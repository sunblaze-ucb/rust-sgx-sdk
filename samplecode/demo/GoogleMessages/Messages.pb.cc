...
const ::google::protobuf::Descriptor* CommandAckMessage_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  CommandAckMessage_reflection_ = NULL;
...
void protobuf_AssignDesc_Messages_2eproto() {
  ...
  CommandMessage_descriptor_ = file->message_type(7);
  ...
  CommandAckMessage_descriptor_ = file->message_type(8);
  static const int CommandAckMessage_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(CommandAckMessage, type_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(CommandAckMessage, size_),
  };
  CommandAckMessage_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      CommandAckMessage_descriptor_,
      CommandAckMessage::default_instance_,
      CommandAckMessage_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(CommandAckMessage, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(CommandAckMessage, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(CommandAckMessage));
}
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
    CommandAckMessage_descriptor_, &CommandAckMessage::default_instance());
}
...
void protobuf_ShutdownFile_Messages_2eproto() {
  ...
  delete CommandAckMessage::default_instance_;
  delete CommandAckMessage_reflection_;
}
...
void protobuf_AddDesc_Messages_2eproto() {
  ...
  CommandAckMessage::default_instance_ = new CommandAckMessage();
  ...
  CommandAckMessage::default_instance_->InitAsDefaultInstance();
...
CommandMessage::CommandMessage()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:Messages.CommandMessage)
}
...
CommandMessage::CommandMessage(const CommandMessage& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:Messages.CommandMessage)
}
...
CommandMessage::~CommandMessage() {
  // @@protoc_insertion_point(destructor:Messages.CommandMessage)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:Messages.CommandMessage)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:Messages.CommandMessage)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:Messages.CommandMessage)
  return false;
#undef DO_
}
...
void CommandMessage::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:Messages.CommandMessage)
  // required uint32 type = 1;
  if (has_type()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(1, this->type(), output);
  }
  ...
  // @@protoc_insertion_point(serialize_end:Messages.CommandMessage)
}

::google::protobuf::uint8* CommandMessage::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:Messages.CommandMessage)
  // required uint32 type = 1;
  if (has_type()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(1, this->type(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Messages.CommandMessage)
  return target;
}
...
#ifndef _MSC_VER
const int CommandAckMessage::kTypeFieldNumber;
const int CommandAckMessage::kSizeFieldNumber;
#endif  // !_MSC_VER

CommandAckMessage::CommandAckMessage()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:Messages.CommandAckMessage)
}

void CommandAckMessage::InitAsDefaultInstance() {
}

CommandAckMessage::CommandAckMessage(const CommandAckMessage& from)
  : ::google::protobuf::Message() {
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:Messages.CommandAckMessage)
}

void CommandAckMessage::SharedCtor() {
  _cached_size_ = 0;
  type_ = 0u;
  size_ = 0u;
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
...
CommandAckMessage::~CommandAckMessage() {
  // @@protoc_insertion_point(destructor:Messages.CommandAckMessage)
  SharedDtor();
}

void CommandAckMessage::SharedDtor() {
  if (this != default_instance_) {
  }
}

void CommandAckMessage::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* CommandAckMessage::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return CommandAckMessage_descriptor_;
}

const CommandAckMessage& CommandAckMessage::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_Messages_2eproto();
  return *default_instance_;
}

CommandAckMessage* CommandAckMessage::default_instance_ = NULL;

CommandAckMessage* CommandAckMessage::New() const {
  return new CommandAckMessage;
}

void CommandAckMessage::Clear() {
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<CommandAckMessage*>(16)->f) - \
   reinterpret_cast<char*>(16))
...
bool CommandAckMessage::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:Messages.CommandAckMessage)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:Messages.CommandAckMessage)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:Messages.CommandAckMessage)
  return false;
#undef DO_
}

void CommandAckMessage::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:Messages.CommandAckMessage)
  // required uint32 type = 1;
  if (has_type()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(1, this->type(), output);
  }
  ...
  // @@protoc_insertion_point(serialize_end:Messages.CommandAckMessage)
}

::google::protobuf::uint8* CommandAckMessage::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:Messages.CommandAckMessage)
  // required uint32 type = 1;
  if (has_type()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(1, this->type(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Messages.CommandAckMessage)
  return target;
}

int CommandAckMessage::ByteSize() const {
  int total_size = 0;
...
void CommandAckMessage::MergeFrom(const ::google::protobuf::Message& from) {
  GOOGLE_CHECK_NE(&from, this);
  const CommandAckMessage* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const CommandAckMessage*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
...
void CommandAckMessage::MergeFrom(const CommandAckMessage& from) {
  GOOGLE_CHECK_NE(&from, this);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_type()) {
      set_type(from.type());
...
void CommandAckMessage::CopyFrom(const ::google::protobuf::Message& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void CommandAckMessage::CopyFrom(const CommandAckMessage& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool CommandAckMessage::IsInitialized() const {
  if ((_has_bits_[0] & 0x00000003) != 0x00000003) return false;

  return true;
}

void CommandAckMessage::Swap(CommandAckMessage* other) {
  if (other != this) {
    std::swap(type_, other->type_);
    std::swap(size_, other->size_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
...
::google::protobuf::Metadata CommandAckMessage::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = CommandAckMessage_descriptor_;
  metadata.reflection = CommandAckMessage_reflection_;
  return metadata;
}
